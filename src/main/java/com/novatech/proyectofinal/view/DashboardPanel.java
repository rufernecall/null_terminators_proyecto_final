...
import com.novatech.proyectofinal.controller.ReporteController;
    ...
    private void cargarEstadisticas() {
        new Thread(() -> {
            try {
                ...
                List<Venta> recientes = controller.getUltimasVentas(8);
                SwingUtilities.invokeLater(() -> {
                    modelo.setRowCount(0);
                    DateTimeFormatter fmt = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
                    for (Venta o : recientes) {
                ...
                pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pnlMainLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(pnlGrid, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 819,
                                                Short.MAX_VALUE)
                                        .addGroup(pnlMainLayout.createSequentialGroup()
        ...
        pnlMainLayout.setVerticalGroup(
                pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pnlMainLayout.createSequentialGroup()
                                ...
                                .addComponent(lblTitulo)
                                .addGap(30, 30, 30)
                                .addComponent(pnlGrid, javax.swing.GroupLayout.PREFERRED_SIZE, 130,
