package com.null_terminators.proyectofinal;

import com.formdev.flatlaf.FlatDarkLaf;
import com.null_terminators.proyectofinal.view.LoginFrame;
...
public class ProyectoFinal {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            ...
            com.null_terminators.proyectofinal.dao.DatabaseConnection.getConnection();
        }).start();
