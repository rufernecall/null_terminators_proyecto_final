...
public class InventarioPanel extends javax.swing.JPanel {
    ...
    private com.null_terminators.proyectofinal.model.Usuario usuarioLogueado;

    public InventarioPanel(com.null_terminators.proyectofinal.model.Usuario usuario) {
        this.usuarioLogueado = usuario;

        // Inicializacion de btnEntrada ANTES de initComponents para evitar NullPointerException en el Layout
        ...
        btnEntrada.addActionListener(e -> btnEntradaActionPerformed(e));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addComponent(btnNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 110,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(10, 10, 10)
                                                .addComponent(btnEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, 110,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(10, 10, 10)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(btnNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEntradaActionPerformed(java.awt.event.ActionEvent evt) {
        if (usuarioLogueado.getEmpleado() == null) {
            JOptionPane.showMessageDialog(this, "El usuario no tiene un empleado vinculado.");
            return;
        }
        EntradaStockForm form = new EntradaStockForm(null, true, usuarioLogueado.getEmpleado());
        form.setVisible(true);
        listarProductos("");
        cargarKpis();
    }
