...
public class ReporteUtil {
    ...
    public static void generarBoletaPDF(OrdenVenta orden, List<DetalleOrdenVenta> detalles) {
        ...
        if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try (FileOutputStream fos = new FileOutputStream(file)) {
                ...
                document.add(new Paragraph("Cliente: " + (orden.getCliente() != null ? orden.getCliente().getNombre() : "General"), fontNormal));
                ...
                for (DetalleOrdenVenta d : detalles) {
                    table.addCell(new PdfPCell(new Paragraph(d.getProducto() != null ? d.getProducto().getNombre() : "N/A", fontNormal)));
                    ...
                    PdfPCell cPrecio = new PdfPCell(new Paragraph(String.format("S/ %.2f", d.getPrecioUnitario()), fontNormal));
                ...
                // Resumen Final
                Paragraph totalPar = new Paragraph("\nTOTAL A PAGAR: S/ " + String.format("%.2f", orden.getTotal()), fontTitulo);
