...
/**
 * Formulario de Clientes compatible con NetBeans Designer
 * @author rufernecall
 */
public class ClienteForm extends javax.swing.JDialog {
    ...
    public ClienteForm(java.awt.Frame parent, Cliente c) {
        super(parent, true);
        this.cliente = c;
        initComponents();
        if (c != null) cargarDatos();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            if ((cliente.getId() == null) ? dao.insertar(cliente) : dao.actualizar(cliente)) {
                guardado = true;
                dispose();
            }
        } catch (Exception e) {
