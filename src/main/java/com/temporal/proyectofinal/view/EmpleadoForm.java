...
/**
 * Formulario de Empleados compatible con NetBeans Designer
 * @author rufernecall
 */
public class EmpleadoForm extends javax.swing.JDialog {
    ...
    public EmpleadoForm(java.awt.Frame parent, Empleado e) {
        super(parent, true);
        this.empleado = e;
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            if ((empleado.getId() == null) ? dao.insertar(empleado) : dao.actualizar(empleado)) {
                guardado = true;
                dispose();
            }
        } catch (Exception e) {
